...
R__LOAD_LIBRARY(include/StEffMaker.h++)
R__LOAD_LIBRARY(include/StErfEffMaker.h++)
R__LOAD_LIBRARY(include/StTpcTofEffMaker.h++)
...
#include "include/StErfEffMaker.h"
#include "include/StTpcTofEffMaker.h"

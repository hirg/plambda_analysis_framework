...
const Char_t* StRefMultCorr::getTable() const
{
  if ( mName.CompareTo("refmult", TString::kIgnoreCase) == 0 ) {
    return "./StRefMultCorr/Centrality_def_refmult.txt";
  }
  else if ( mName.CompareTo("refmult2", TString::kIgnoreCase) == 0 ) {
    return "./StRefMultCorr/Centrality_def_refmult2.txt";
  }
  else if ( mName.CompareTo("refmult3", TString::kIgnoreCase) == 0 ) {
    return "./StRefMultCorr/Centrality_def_refmult3.txt";
  }
  else if ( mName.CompareTo("toftray", TString::kIgnoreCase) == 0 ) {
    return "./StRefMultCorr/Centrality_def_toftray.txt";
  }
  else{
...
void StRefMultCorr::readBadRuns()
{
  ...
  for(Int_t i=0; i<2; i++) {
    ...
    const Char_t* inputFileName(Form("./StRefMultCorr/bad_runs_refmult_year%d.txt", year));
